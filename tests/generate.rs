...
async fn tpch_generate_and_convert_to_parquet() {
    ...
    convert_to_parquet(&tpch, &setup.output_path, parquet_path, false, 1, 8192, "snappy", false)
        .await
...
async fn tpcds_generate_and_convert_to_parquet() {
    ...
    convert_to_parquet(&tpcds, &setup.output_path, parquet_path, false, 1, 8192, "snappy", false)
        .await
        .expect("convert_to_parquet failed");
